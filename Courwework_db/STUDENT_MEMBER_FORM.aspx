<%@ Page Title="Student Member" MasterPageFile="~/Site.Master" Language="C#" AutoEventWireup="true" CodeBehind="STUDENT_MEMBER_FORM.aspx.cs" Inherits="Courwework_db.WebForm2" %>
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
        <div class ="jumbotron">
            <div class="container">
                    ...
                    <div class ="row">
                        <div class ="col-xs-6">
                            <h2><span style = "font-weight:bold">Student-Member Details</span></h2>
                        </div>
                        <div class="col-xs-6" >
                            <div class="jumbotron" style="padding:1px; padding-left:20px; float:right"> 
                                <asp:FormView ID="FormView1" runat="server" DataKeyNames="USER_ID,INSTITUTE_REG" DataSourceID="SqlDataSource1">
                                        ...
                                        <div style="background-color:#808080; border-radius:20px; padding:10px">
                                            <div class="container-fluid">
                                                ...
                                                <div class="row" style ="padding:10px">
                                                    ...
                                                    <div class ="col-xs-6">
                                                        <asp:TextBox ID="CONTACTTextBox" runat="server" class ="form-control" Text='<%# Bind("CONTACT") %>' />
                                                    </div>
                                                </div>
                                                <div class="row" style ="padding:10px">
                                                    <div class="col-xs-6">
                                                    ...
                                                    <div class ="col-xs-6">
                                                        <asp:TextBox ID="EMAILTextBox" runat="server" class ="form-control" Text='<%# Bind("EMAIL") %>' />
                                                    </div>
                                                </div>
                                                <div class="row" style ="padding:10px">
                                                    <div class="col-xs-6">
                                                ...
                                                <div class="row" style ="padding:10px">
                                                    ...
                                                    <div class ="col-xs-6">
                                                        <asp:DropDownList ID="DropDownList2" runat="server" class="form-control" DataSourceID="SqlDataSource12" DataTextField="INSTITUTE_NAME" DataValueField="INSTITUTE_REG" SelectedValue='<%# Bind("INSTITUTE_REG") %>'>
                                                        </asp:DropDownList>
                                                        <asp:SqlDataSource ID="SqlDataSource12" runat="server" ConnectionString="<%$ ConnectionStrings:Prashish %>" ProviderName="<%$ ConnectionStrings:Prashish.ProviderName %>" SelectCommand="SELECT INSTITUTE_NAME, INSTITUTE_REG FROM INSTITUTE"></asp:SqlDataSource>
                                                    </div>
                                                </div>
                                    ...
                                    <EmptyDataTemplate>
                                        <asp:LinkButton ID="NewButton" runat="server" class ="btn btn-primary" CausesValidation="False" CommandName="New" Text="Create Member" />
                                    </EmptyDataTemplate>
                                    <ItemTemplate>
                                        <asp:LinkButton ID="NewButton" runat="server" class ="btn btn-primary" CausesValidation="False" CommandName="New" Text="Create Member" />
                                    </ItemTemplate>
